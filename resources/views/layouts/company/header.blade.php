    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="{{ url('/agen-list') }}" class="{{ Request::is('agen-list') ? 'active' : '' }}">Agen List</a></li>
          ...
          <li><a class="get-a-quote" href="{{ url('/login') }}"  class="{{ Request::is('login') ? 'active' : '' }}">Login</a></li>
        </ul>
      </nav><!-- .navbar -->
